...
%%%% Simple COLA dominates both baselines on point estimates and the frontier
%%%% is Simple and Beckett. Every number regenerates from the public repo:
...
Using 30 simulations of 25 seasons for each of 9 mechanisms (6,750 seasons total), we identified a frontier of two viable mechanisms. Notably, one mechanism directly dominates both 3-2-1 Lottery and the 2019--2026 NBA Lottery on point estimates. The table summarizes the results.
% Filled from the 25-season run. "2019--2026": the June 2026 draft also ran under
% the old rules; 3-2-1 first applies to the 2027 draft. "On point estimates": the
% help and tanking differences clear their paired 95% intervals, the never-winner
% differences do not.
